...
const BtcForm = () => {
  ...
  return (
    <div className='text-white bg-[#070b1d] flex items-center justify-center gap-[2rem] rounded-2xl overflow-hidden  h-[40rem]'>
      ...
      <Card className='wallet-card rounded-2xl overflow-hidden gap-y-[2rem]'>
        ...
        <div className='bg-[#1235ec] text-white rounded-xl w-[45rem] border-4 h-[7rem] text-wrap p-[1rem]'>
